...
//         {/* Navbar */}
//         <header className="border-b border-slate-800 backdrop-blur-xl bg-slate-950/50 sticky top-0 z-20">
...
//               <button
//                 onClick={() => navigate("/signup")}
//                 className="border border-slate-700 hover:border-slate-500 px-8 py-4 rounded-2xl font-semibold text-lg transition"
//               >
//                 Book Demo
//               </button>
//             </div>
...
//           {/* Dashboard Preview */}
//           <div className="bg-slate-900/70 border border-slate-800 rounded-3xl shadow-2xl p-8 backdrop-blur-xl">
...
//               <div
//                 key={index}
//                 className="bg-slate-900/70 border border-slate-800 rounded-3xl p-8 hover:border-blue-500/40 transition shadow-lg"
//               >
