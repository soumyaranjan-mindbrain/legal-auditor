    ...
    return (
        <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                    { label: 'Reports Generated', value: '482', icon: FileText, detail: 'This Quarter' },
                    { label: 'Audit Accuracy', value: '99.8%', icon: Activity, detail: 'Infrastructure Target' },
                    { label: 'Client Retention', value: '94%', icon: PieChart, detail: 'Annual Factor' },
                ].map((stat, idx) => (
                    <div key={idx} className="border border-zinc-200 dark:border-zinc-800 rounded-lg p-6 bg-white dark:bg-zinc-950 shadow-sm">
